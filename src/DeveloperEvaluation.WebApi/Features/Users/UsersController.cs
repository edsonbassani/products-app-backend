...
public class UsersController : BaseController
{
    ...
    public UsersController(IMediator mediator, IMapper mapper, IBus bus, ILogger<UsersController> logger)
    {
        _mediator = mediator;
        _mapper = mapper;
        _bus = bus;
    ...
    public async Task<IActionResult> DeleteUser([FromRoute] Guid id, CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation("User deleted with ID {UserId}", request.Id);
